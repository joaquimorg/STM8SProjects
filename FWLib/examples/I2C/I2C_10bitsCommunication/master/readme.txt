/** @page I2C_10bitsMasterCommunication Master transmitter Communication between two I2C peripherals 
  ...
  - In 10bit addressing mode master transmitter with a clock speed set to 100KHz.
 ...
 @par Hardware and Software environment
  ...
  @section note Note
  - Before running the program, be sure that the slave program is already running
